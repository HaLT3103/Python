...
class Interface(Game):
    ...
    def draw_main(self):
        ...
        self.screen.blit(pg.transform.scale(pg.image.load(f"{APP_PATH}/images/BG/BG.jpg"), (self.width, self.height + 2)), (0, 0))
        self.screen.blit(pg.transform.scale(pg.image.load(f"{APP_PATH}/images/elements/around_arrow.png"), (43, 43)), (453, 159))
        self.screen.blit(pg.transform.scale(pg.image.load(f"{APP_PATH}/images/elements/arrow.png"), (58, 58)), (374, 154))
        self.screen.blit(pg.transform.scale(pg.image.load(f"{APP_PATH}/images/elements/home.png"), (38, 38)), (314, 162))

        self.screen.blit(pg.font.Font(self.generalFont, 17).render('HIGH SCORE', True, config.COLORS['GRAY']), (402, 55))
